...
class ConvolutionalBatchNormWithRCProcessingBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(ConvolutionalBatchNormWithRCProcessingBlock, self).__init__()
...
class ConvolutionalBatchNormRCDimensionalityReductionBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(ConvolutionalBatchNormRCDimensionalityReductionBlock, self).__init__()
